    ...
    return (
        <div className='Cover block'>
            ...
            <div className='Cover-inner'>
                <h1 className='random'>
                    M<span style={{fontSize: '42px',verticalAlign: ''}}>agma</span>M<span style={{fontSize: '41px',verticalAlign: ''}}>in<span style={{fontSize: '40px',verticalAlign: ''}}>ds</span></span>
                    </h1>{/* Have letters walk/scoot together into rough formation (think pixar lamp) and then swing into place as if on hinges, design effect as if heavy */}
                ...
                <p>Next level media. {/* Phase-in from left-to-right */}
                    Next level marketing.{/* Phase-in after */} Next level sales.</p>{/* Phase-in last */}
            </div>
            </div>
        </div>
    )
