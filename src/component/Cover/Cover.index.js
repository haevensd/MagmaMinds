    ...
    return (
        <div className='Cover block'>
            ...
            <div className='Cover-inner'>
                <h1 className='random'>
                    M<span style={{fontSize: '42px',verticalAlign: 'text-bottom'}}>agma</span>M<span style={{fontSize: '42px',verticalAlign: 'text-bottom'}}>in<span style={{fontSize: '42px',verticalAlign: 'text-bottom'}}>ds</span></span>
