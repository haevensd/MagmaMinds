                ...
                <div className='HWW-inner'>
                    ...
                    <div className='list'>
                        <div className={`list-item ${isVisible ? 'animate' : ''}`}>
                            ...
                            <div>
                                <h3>Pick Creators</h3>
                                <p>Choose from a list of creators hand-picked best for your target market.</p>
                            </div>
                        </div>
                    ...
                    <button className={`intro-call-btn ${isVisible ? 'animate' : ''}`}>Schedule an Intro Call Today!</button>
                </div>
            </div>
        </div>
    )
